...
/**
 * Created by linxiaoke on 6/15/18.
 */
public class StepImagePagerActivity extends Activity {
    ...
    public static void startImagePagerActivity(Context context, List<String> imgUrls, int position, ImageSize imageSize) {
        Intent intent = new Intent(context, StepImagePagerActivity.class);
